...
The purpose of this file is to become familiar with the connecting a client
to an extant server, as well as understanding how to use the car state and 
...
# that this program want to communicate through the API
...
# NOTE: functions that begin w/ 'sim' are not available IRL (I forget where I 
# saw this, but I did see it)
